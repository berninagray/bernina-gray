	...
	<body>
		...
		<div>
			...
			<p>This section will highlight my professional history, with emphasis on my recently acquired technical skills. <br>
				...
				My "About Me" will be featured after my projects and my "Portfolio" section will be featured <br>
				with a homepage down transition. Lastly, my "Contact" info will be found at the very bottom of the page. <br>
				</p>
			<p><strong>Porfolio:</strong></p>
			<p>I want this section to be clean, simpleeand able to keep a visitor's interest. My projects will be <br>
				navigatable with a swipe down action with each project in its' own space. It will feature 4 <br>
				examples of my best work.</p>
			<p><strong>Contact:</strong></p>
			<p>The contact section will include my professional email link. There will also be link icons to Github and LinkedIn.<br>
			</p>
			<h2>Wireframes</h2>
